...
carry-over and the GitHub-issue question before interviewing the author below.
...
release chunks, and the closing briefing before writing the plan. Write the plan to `DESIGN_REVIEW_PLAN.md`
in the project root. In each chunk's description, say what the chunk does or
asks and reference the originating finding inline.
