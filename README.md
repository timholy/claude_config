This repository holds a personal configuration for agentic coding. For me, this repo is my `~/.claude` folder (with a lot of material `git-ignore`d).
...
In addition to CLAUDE.md, a few skills are stored in `commands/`.

Unless you are a Julia user, it may not be relevant for you.
